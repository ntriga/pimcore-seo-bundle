...
use Ntriga\PimcoreSeoBundle\Manager\QueueManagerInterface;
...
class PimcoreElementListener implements EventSubscriberInterface
{
    ...
    public function onDocumentPostUpdate(DocumentEvent $event): void
    {
        ...
        $dispatchType = $event->getDocument()->isPublished() === false ? IndexWorkerInterface::TYPE_DELETE : IndexWorkerInterface::TYPE_UPDATE;
