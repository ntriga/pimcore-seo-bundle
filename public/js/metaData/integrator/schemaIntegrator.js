pimcore.registerNS('NtrigaSeo.MetaData.Integrator.SchemaIntegrator');
NtrigaSeo.MetaData.Integrator.SchemaIntegrator = Class.create(NtrigaSeo.MetaData.Integrator.AbstractIntegrator, {
    ...
    getSchemaField: function (fieldId) {
        ...
        lfExtension = new NtrigaSeo.MetaData.Extension.LocalizedFieldExtension(fieldId, this.getAvailableLocales());
