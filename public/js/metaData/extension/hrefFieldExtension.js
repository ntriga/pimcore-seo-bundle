pimcore.registerNS('NtrigaSeo.MetaData.Extension.HrefFieldExtension');
NtrigaSeo.MetaData.Extension.HrefFieldExtension = Class.create({
    ...
    generateElement: function () {
        ...
        this.href = Ext.create('NtrigaSeo.HrefTextField', options);
