pimcore.registerNS('NtrigaSeo.MetaData.Extension.IntegratorValueFetcher');
NtrigaSeo.MetaData.Extension.IntegratorValueFetcher = Class.create({
    ...
    fetchForPreview: function (name, locale) {
        ...
        const value  = this.fetch(name, locale);
    ...
    findValueInData: function (values, name, locale) {
        let currentValueData, storedValue = null;
